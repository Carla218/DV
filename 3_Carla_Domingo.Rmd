...
Answer:
Example 1: dynamic
Example 2: interactive plot area
Example 3: interactive plot area
Example 4: dynamic and interactive plot area and controls
&emsp;
</div>
...
&emsp;<i class="fas fa-comment-dots"></i>
Answer:
Plotly adds interactive plot area and controls as hover, click, zoom, choose data set,...
&emsp;
</div>
...
<strong>	Displays bold text to emphasize important words.
<em>	Displays italic text for emphasis.
<code>	Shows text in a code-style font.
<a href="URL">	Creates a hyperlink to another webpage.
<img src="URL">	Displays an image from the given source.
<center>	Centers content horizontally on the page.
&emsp;
</div>
