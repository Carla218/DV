...
```
Continuous: position, transparency and size
Discrete: all aesthetics (color, shape, line type, position, transparency and size)
...
```
The observations are grouped by the factors cyl and am.
...
Geom_line, geom_path, geom_polygon and geom_area.
...
### Upload `1.Rmd` with the completed exercises (text included) to [Atenea](https://atenea.upc.edu/course/view.php?id=105474)
